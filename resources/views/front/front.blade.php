...
@section('content')
    <div class="container block block-cells">
        <div class="row text-center">
            <div class="col-lg-4 col-md-12">
                ...
                <h3 class="title">LOGISTICS FOR BUSINESS CUSTOMERS</h3>
                <p class="text">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                    ...
                    <div class="text text-left">
                        <p>
                            Parsendo has established itself as one of the industry leaders when it comes down to
                            comprehensive
                            logistics
                            ...
                            thousands of
                            positive reviews from our clients all over the world. Parsendo has been credited for simplifying
                            business
    ...
    <div class="block why-us content-block">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                    <h2 class="title text-center">WHY PARSENDO.COM?</h2>
                    <div class="text text-left">
                        <p>
                            Parsendo has established itself as one of the industry leaders when it comes down to
